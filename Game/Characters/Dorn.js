...
this.hp = 100;
this.damagemod = 0.9; //It's hard to hurt a slime...
...
this.hitstunmod = 1.3; //Do you know how hard it is to reform after each hit!!!
